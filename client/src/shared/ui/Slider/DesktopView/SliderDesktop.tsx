...
import cls from './SliderDesktop.module.scss';
...
export const SliderDesktop: FC<SliderDesktopProps> = memo((props) => {
    const {
        className,
        images,
    } = props;
    ...
    return (
        <div className={classNames(cls.SliderDesktop, {}, [className])}>
            <div
